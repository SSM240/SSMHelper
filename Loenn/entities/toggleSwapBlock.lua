...
toggleSwapBlock.name = "SSMHelper/ToggleSwapBlock"
toggleSwapBlock.nodeLimits = {1, 1}
toggleSwapBlock.fieldInformation = {
    theme = {
...
toggleSwapBlock.warnBelowSize = {16, 16}

for i, theme in ipairs(themes) do
    toggleSwapBlock.placements[i] = {
        name = string.lower(theme),
        data = {
            width = 16,
            height = 16,
            theme = theme,
            renderBG = theme == "Normal" and true or false
        }
    }
end
...
function toggleSwapBlock.sprite(room, entity)
    ...
    addTrailSprites(sprites, entity, themeData.trail, entity.renderBG)
    addBlockSprites(sprites, entity, entity, themeData.frame, themeData.middle)

    return sprites
end

function toggleSwapBlock.nodeSprite(room, entity, node)
    local sprites = {}
